...
Lección aprendida: Nunca inyectar datos arbitrarios en una extracción cruda a menos que se comprenda absoluta y milimétricamente el esquema de codificación subyacente.
